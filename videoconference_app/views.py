...
def login_view(request):
    if request.method=="POST":
        ...
        if user is not None:
            ...
            return render(request,'login.html', {'error': "Don't you know your Password? Please Remember your Password.Please try again Later"})
...
def join_room(request):
    ...
    return render(request, 'joinroom')
